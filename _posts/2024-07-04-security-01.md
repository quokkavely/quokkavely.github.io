...
1. **SSR**(Server Side Rendering) 방식의 애플리케이션은 세션 기반의 폼 로그인 방식을 적용하기 가장 적합한 애플리케이션이며, 또한 폼 로그인 방식은 Spring Security에 처음 입문하는 사람들이 이해하기에 가장 적합한 인증 방식
    ⭐ CSR(Client Side Rendering) 방식으로 이때동안 애플리케이션 구현 해왔지만,  Spring Security를 입문하기 위해 SSR 방식 사용
...
- 내 마음대로 아이디와 비밀 번호를 적으면 실패까지 알려준다.
    ...
    <img src="https://github.com/quokkavely/quokkavely.github.io/assets/165968530/710c20e0-d20f-48d9-a5dd-2614834d58ca" width=400/>
...
2. **SecurityConfiguration  클래스에 로그아웃 설정 추가**
    ...
    - 로그아웃 클릭 시 헤더가 바뀌게 됨.
        ...
        <img src="https://github.com/quokkavely/quokkavely.github.io/assets/165968530/a1b0706e-cdfe-44fb-9225-8eb3ac5901b3" width=400/>
